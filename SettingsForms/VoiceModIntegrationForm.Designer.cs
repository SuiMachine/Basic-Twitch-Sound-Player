...
{
	partial class VoiceModIntegrationForm
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VoiceModIntegrationForm));
			...
			((System.ComponentModel.ISupportInitialize)(this.VoicesDataGrid)).BeginInit();
			this.SuspendLayout();
			// 
			// tableLayoutPanel1
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.VoicesDataGrid, 0, 3);
			...
			this.L_Status.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.tableLayoutPanel4.Controls.Add(this.TB_API_KEY, 1, 0);
			...
			// TB_API_KEY
			// 
			this.TB_API_KEY.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.tableLayoutPanel5.Controls.Add(this.B_Connect, 0, 0);
			this.tableLayoutPanel5.Controls.Add(this.B_Disconnect, 0, 0);
			...
			this.tableLayoutPanel6.Controls.Add(this.ProgressBar_Update, 4, 0);
			...
			((System.ComponentModel.ISupportInitialize)(this.VoicesDataGrid)).EndInit();
